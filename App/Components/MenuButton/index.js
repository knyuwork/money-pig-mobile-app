  ...
  onSelect = (index, value) => {
    ...
    switch (value) {
      case 'View Product':
        ...
        const { singleId: productId } = getNavigationProps(navigation, 'metadata') //singleId is the same as productId
  ...
  render() {
    ...
    return (
      <ModalDropdown 
        ...
        options={options} >
        <Icon style={{marginRight: 8}} color={navigationOptions.headerTintColor} size={20} name={'dots-three-vertical'} />
      </ModalDropdown>
    );
  }
}
